...
const SECTORS = {
  'E-Commerce': {
    ...
    'Pet Products': ['pet products', 'pet supplies'],
    'Home Fitness Equipment': ['fitness equipment', 'home fitness'],
  },
  'Professional Services': {
    ...
    'Solicitors': ['solicitors', 'law firm'],
  },
  'Security': {
    'Managed Services': ['managed security services', 'managed services'],
    'Fire/House Alarms': ['fire alarm', 'burglar alarm', 'intruder alarm'],
    'Security Consultancy & Risk': ['security consulting', 'risk management'],
    'CCTV': ['cctv', 'video surveillance'],
  },
  'Recruitment/HR': {
    'Recruitment': ['recruitment', 'recruiting'],
    'Tech/IT Recruitment': ['it recruitment', 'tech recruitment'],
    'HR Software/Technology': ['hr software', 'hr technology'],
    'Temporary/Contract Staffing': ['temporary staffing', 'contract staffing'],
    'HR Consultants': ['human resources', 'hr consulting'],
    'Pay, HR & Payroll': ['payroll'],
  },
  'Healthcare': {
    'Private Dentists': ['dental', 'dentist'],
    'Cosmetic Clinics': ['cosmetic clinic', 'aesthetics', 'medical aesthetics'],
    'Private GPs': ['private gp', 'general practice', 'private clinic'],
    ...
    'Private Hospitals': ['private hospital', 'private healthcare'],
  },
  'Transport & Logistics': {
    'Courier Services': ['courier', 'same day delivery'],
    'Removals': ['removals', 'moving company', 'house removals'],
    'Fleet Management': ['fleet management'],
    'Heavy Haulage': ['haulage', 'heavy haulage', 'freight'],
    'Chauffeur Services': ['chauffeur', 'executive travel'],
  },
};

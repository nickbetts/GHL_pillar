...
async function upsertLead(sql, lead, ownerOverride = null, skipCompanyMatch = false) {
  ...
  const rows = await sql`
    ...
    ON CONFLICT (email) DO UPDATE SET
      ...
      company_name      = COALESCE(queue_leads.company_name, EXCLUDED.company_name),
      company_website   = COALESCE(queue_leads.company_website, EXCLUDED.company_website),
      company_industry  = COALESCE(queue_leads.company_industry, EXCLUDED.company_industry),

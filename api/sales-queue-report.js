...
export default async function handler(req, res) {
  ...
  try {
    ...
    const stageProgressRows = await sql`
      SELECT
    ...
    const stageProgress = stageProgressRows[0] || {};
    const summary = {
      ...
      meetingBooked: stageProgress.meeting_booked || 0,
      meetingAttended: stageProgress.meeting_attended || 0,
      proposal: stageProgress.proposal || 0,
      won: stageProgress.won || 0,
